      ...
      <section style={styles.sheet}>
        ...
        <div style={styles.derivedRow}>
          ...
          <StatBox label="Iniziativa" value={fmt(iniziativa)} sub="DES + bonus manuale + extra">
            ...
            <button style={{ ...styles.diceBtn, marginLeft: 8 }} onClick={() => openD20Roll({ title: "Tiro Iniziativa", modifier: iniziativa, modifierLabel: `Iniziativa ${fmt(iniziativa)}` })} title="Tira l'iniziativa (non modifica nulla sulla scheda)">🎲</button>
          </StatBox>
